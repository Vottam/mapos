    ...
    var myChart = new Chart(ctx, {
        data: {
            ...
            datasets: [{
                    ...
                    data: [<?php echo($financeiro_mes->VALOR_JAN_REC - $financeiro_mes->VALOR_JAN_DES - $financeiro_mes->VALOR_JAN_CUSTO_TOTAL); ?>,
                        <?php echo($financeiro_mes->VALOR_FEV_REC - $financeiro_mes->VALOR_FEV_DES - $financeiro_mes->VALOR_FEV_CUSTO_TOTAL); ?>,
                        <?php echo($financeiro_mes->VALOR_MAR_REC - $financeiro_mes->VALOR_MAR_DES - $financeiro_mes->VALOR_MAR_CUSTO_TOTAL); ?>,
                        <?php echo($financeiro_mes->VALOR_ABR_REC - $financeiro_mes->VALOR_ABR_DES - $financeiro_mes->VALOR_ABR_CUSTO_TOTAL); ?>,
                        <?php echo($financeiro_mes->VALOR_MAI_REC - $financeiro_mes->VALOR_MAI_DES - $financeiro_mes->VALOR_MAI_CUSTO_TOTAL); ?>,
                        <?php echo($financeiro_mes->VALOR_JUN_REC - $financeiro_mes->VALOR_JUN_DES - $financeiro_mes->VALOR_JUN_CUSTO_TOTAL); ?>,
                        <?php echo($financeiro_mes->VALOR_JUL_REC - $financeiro_mes->VALOR_JUL_DES - $financeiro_mes->VALOR_JUL_CUSTO_TOTAL); ?>,
                        <?php echo($financeiro_mes->VALOR_AGO_REC - $financeiro_mes->VALOR_AGO_DES - $financeiro_mes->VALOR_AGO_CUSTO_TOTAL); ?>,
                        <?php echo($financeiro_mes->VALOR_SET_REC - $financeiro_mes->VALOR_SET_DES - $financeiro_mes->VALOR_SET_CUSTO_TOTAL); ?>,
                        <?php echo($financeiro_mes->VALOR_OUT_REC - $financeiro_mes->VALOR_OUT_DES - $financeiro_mes->VALOR_OUT_CUSTO_TOTAL); ?>,
                        <?php echo($financeiro_mes->VALOR_NOV_REC - $financeiro_mes->VALOR_NOV_DES - $financeiro_mes->VALOR_NOV_CUSTO_TOTAL); ?>,
                        <?php echo($financeiro_mes->VALOR_DEZ_REC - $financeiro_mes->VALOR_DEZ_DES - $financeiro_mes->VALOR_DEZ_CUSTO_TOTAL); ?>
                    ],
