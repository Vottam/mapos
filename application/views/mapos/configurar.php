                        ...
                        <div class="control-group">
                            ...
                            <div class="span8">
                                ...
                                <div class="span10" style="margin-left: 3em;">
                                    ...
                                    <label> <input <?= @in_array("Entregue", json_decode($configuration['os_status_list'])) == 'true' ? 'checked' : ''; ?> name="os_status_list[]" class="marcar" type="checkbox" value="Entregue"> <span class="lbl"> Entregue</span> </label>
                            ...
                            <div class="span8">
                                ...
                                <div class="span10" style="margin-left: 3em;">
                                    ...
                                    <label> <input <?= @in_array("Entregue", $osStatusEmailNotifyList) == 'true' ? 'checked' : ''; ?> name="os_status_email_notify_list[]" class="marcar" type="checkbox" value="Entregue"> <span class="lbl"> Entregue</span> </label>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="apiExpireTime" id="apiExpireTime">
                                    <option value="60" <?= ($_ENV['API_TOKEN_EXPIRE_TIME'] ?? 60) == 60 ? 'selected' : '' ?>>1 minuto</option>
                                    <option value="3600" <?= ($_ENV['API_TOKEN_EXPIRE_TIME'] ?? 60) == 3600 ? 'selected' : '' ?>>1 hora</option>
                                    <option value="86400" <?= ($_ENV['API_TOKEN_EXPIRE_TIME'] ?? 60) == 86400 ? 'selected' : '' ?>>1 dia</option>
                                    <option value="604800" <?= ($_ENV['API_TOKEN_EXPIRE_TIME'] ?? 60) == 604800 ? 'selected' : '' ?>>1 semana</option>
                                    <option value="2592000" <?= ($_ENV['API_TOKEN_EXPIRE_TIME'] ?? 60) == 2592000 ? 'selected' : '' ?>>1 mês</option>
                                </select>
